...
export default function UserCard({ user, onSave }: UserCardProps) {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 transition-colors">
      <div
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 w-full max-w-md p-8 transition-all duration-500 hover:shadow-xl
        animate-fadeInScale"
      >
        {/* Header */}
